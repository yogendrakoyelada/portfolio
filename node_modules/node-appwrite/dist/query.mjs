 ...
 * @returns {string}
 */
_Query.vectorDot = (attribute, vector) => new _Query("vectorDot", attribute, [vector]).toString();
/**
 ...
 * @returns {string}
 */
_Query.vectorCosine = (attribute, vector) => new _Query("vectorCosine", attribute, [vector]).toString();
/**
 ...
 * @returns {string}
 */
_Query.vectorEuclidean = (attribute, vector) => new _Query("vectorEuclidean", attribute, [vector]).toString();
/**
